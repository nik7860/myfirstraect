...
export default function Textform(props) {
  ...
  return (
    <><div className='container'>
      ...
      <button className='btn btn-primary mx-2 my-1' onClick={handlelclick}>Lower case</button>
      <button className='btn btn-primary mx-2 my-1' onClick={handlelclear}>Clear</button>
